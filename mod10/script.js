const students = [
    {
        firstName: "Александр",
        lastName: "Проскуряков",
        middleName: "Сергеевич",
        dob: new Date("2005-03-28"),
        startYear: 2022,
        faculty: "ИРИТ-РТФ"
    },
    {
...
function filterStudents() {
    ...
    const filteredStudents = students.filter((student) => {
        ...
        return (
            ...
            (!filterLastName || fullName.includes(filterLastName)) &&
            (!filterMiddleName || fullName.includes(filterMiddleName)) &&
            (!filterFaculty || student.faculty.toLowerCase().includes(filterFaculty)) &&
            (!filterStartYear || student.startYear === filterStartYear) &&
            (!filterGraduationYear || student.startYear + 4 === filterGraduationYear)
        );
    });
